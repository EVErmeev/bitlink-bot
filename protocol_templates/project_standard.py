...
class ProjectStandardTemplate(BaseProtocolTemplate):
    ...
    def assemble_from_llm_json(self, protocol: Protocol, atomic_items: list,
        ...
        protocol.meeting_purpose = llm_data.get("purpose_and_scope", llm_data.get("meeting_purpose", ""))
        protocol.meeting_context = llm_data.get("meeting_context", "")
        protocol.key_outcomes = llm_data.get("key_outcomes", "")
        protocol.process_scheme = llm_data.get("process_scheme", "")
        protocol.agreed_approaches = llm_data.get("agreed_approaches", "")
        protocol.functional_gaps = llm_data.get("functional_gaps", "")
        ...
        thematic_sections_data = llm_data.get("thematic_sections", [])
        protocol.thematic_sections = thematic_sections_data
